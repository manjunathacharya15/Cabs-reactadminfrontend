...
import {  faCog, faHome, faSearch,faTrashAlt,faPlus,faPencilAlt, faEye } from '@fortawesome/free-solid-svg-icons';
...
export default class buttons extends Component {
      ...
      this.setState({customers:
        result.map(e => {
          return{
            ...
            emailid:e.oemail,
            aadharcard:e.daadharprooffront
  ...
  customerList() {
    ...
    return this.state.customers.map(currentcustomer => (
      ...
      <td style={{border:"1px double black",textAlign:"center"}}><Link to={"/components/enrolledit/"+currentcustomer.id}><FontAwesomeIcon icon={faEye}/></Link>/<Link to={"/components/editenroll/"+currentcustomer.id}><FontAwesomeIcon icon={faPencilAlt} /></Link></td>
